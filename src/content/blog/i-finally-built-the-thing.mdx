...
It started the way most things start. You look at what someone else built and think, I want that. I landed on zenorocha.com one afternoon and just sat there. Clean, fast, minimal. A command palette. Dark mode done properly. I closed the tab, opened it again, and decided that was enough inspiration to actually begin.
